...
const Navigation = () => {
  ...
  return (
    <div className='bg-cyan-800 text-white  w-full flex justify-between items-center p-4 font-bold  gap-6 '>
        <h1 className='font-serif'> <span className='text-4xl font-serif '>S</span>hop <span className='text-2xl font-serif '>S</span>top <i className="ri-shopping-bag-4-fill text-blue-100 text-2xl"></i></h1>
