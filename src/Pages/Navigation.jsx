  ...
  return (
    <div className='bg-cyan-800 text-white  w-full flex justify-between items-center p-4 font-bold  gap-6 relative'>
      ...
      <nav className='flex gap-9' >
        ...
        <Link to='/womens' className='hover:border-b active:scale-90 mt-1'>Womens</Link>
        <Link to='/mens' className='hover:border-b active:scale-90 mt-1'>Mens</Link>
        <Link to='/cart' className='hover:border-b active:scale-90 mt-1'><i className="ri-shopping-cart-line"></i><span className='ml-1 bg-white text-cyan-500 h-5 w-5 rounded-full inline-flex items-center justify-center text-sm '>{cart.length}</span></Link>
