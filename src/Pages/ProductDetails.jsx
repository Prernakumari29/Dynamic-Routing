...
const ProductDetails = () => {
  ...
  return (
    ...
    <div>
      <h1 className='  text-3xl  m-10 font-serif'> <i className="ri-arrow-left-line cursor-pointer " onClick={()=>navigate(-1)}></i> {SingleProduct.name} <span className='text-gray-600 text-2xl pl-2'>({SingleProduct.title})</span></h1>
    ...
    <div className='flex flex-col gap-2 '>
        ...
        {/* -------------------------------------Detailing part---------------------------------------------------------- */}
        <h1 className=' border-t mt-0.5'>  <span className='font-bold'> Brand : </span>{SingleProduct.brand}</h1>
        <h1 >  <span className='font-bold'>stock : </span>{SingleProduct.stock}</h1>
        <h1> <span className='font-bold'>Delivery : </span>{SingleProduct.delivery}</h1>
